...
class ApiHandler {
public:
    explicit ApiHandler(app::Application& app, const bool is_test_tick_mode);
...
public:
    ...
    explicit RequestHandler(app::Application& app, std::filesystem::path path_static_content, Strand api_strand, const bool is_test_tick_mode);
